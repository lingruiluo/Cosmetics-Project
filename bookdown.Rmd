...
<select>
  <option value="o1">Moisturizer</option>
  <option value="o2">Cleanser</option>
  <option value="o3">Treatment</option>
  <option value="o4">Face Mask</option>
  <option value="o4">Eye Cream</option>
  <option value="o4">Sun Protect</option>
</select>
